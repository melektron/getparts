...
async def request_part_info_mouser(code_data: bytes) -> MouserPartInfo | None:
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(
            ...
            return MouserPartInfo(
                ...
                mouser_part_number=         part_descriptor["MouserPartNumber"],
